		...
		typewrite : function(curString, curStrPos) {
			...
			self.timeout = setTimeout(
					function() {
						...
						// format: \^\d+ .. eg: ^1000 .. should be able to print
						// the ^ too using ^^
						...
						if (self.contentType === 'html') {
							...
							if (curChar === '<' || curChar === '&') {
								...
								while (curString.substr(curStrPos + 1)
										.charAt(0) !== endTag) {
						...
						self.timeout = setTimeout(function() {
							if (curStrPos === curString.length) {
								...
								// start typing each new char into existing
								// string
								// curString: arg, self.el.html: original text
								// inside element
		...
		backspace : function(curString, curStrPos) {
			...
			self.timeout = setTimeout(
					function() {
						...
						// the stopNum actually represents the amount of chars
						// to
